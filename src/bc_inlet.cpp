...
void BC_Inlet(int bind, int bnode, int sbind, int ebind, double ***&si, double ***&sj, double ***&cv,
    ...
    double rhoe, ue, ve, pe, qqe, qq2e, qn, crho0, rhoa, ua, va, pa, pb, ul, vl, pl, sgn, cosa, co2, rinv, dis, cb, cco2, Tb, rhob, uabsb, ub, vb;
    maxwchg = 0.0;
